...
import {loadFile, createModel,buildOpenAPIToolkit} from "./utils.js"
import { createOpenApiAgent } from "langchain/agents/toolkits";
...
const tk=await buildOpenAPIToolkit("./data/simple.json");
...
const agent = createReactAgent({
  llm:createModel(),
  tools:[],//tk.getTools(),
 prompt:" You also have openapi spec for a rest api: " + await loadFile("./data/simple.json"),
});
const rl = readline.createInterface({
  input: process.stdin,
  output: process.stdout,
});
let agent_scratchpad='';
